...
<body>
	<div class="main">
		<div class="container a-container" id="a-container">
			<form class="form" id="a-form" method="post" action="/asm/email">
				...
				<span class="form__span">Enter your email that you 
					registered before </span>
				<input class="form__input" type="email" placeholder="Email" name="email">
				<div class="text-start text-danger w-75 ps-5"><span style="color: red">${msg}</span></div>
				<button class="form__button button submit" formaction="/asm/email/getpass">SEND CODE</button>
			</form>
		</div>
*
	</div>
