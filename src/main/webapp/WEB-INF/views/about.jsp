			...
			<div class="row">
				<div class="col-lg-12">
					<div class="about__pic">
						<img src="/static/img/about/about-us.jpg" alt="">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="about__item">
						...
						<p>Contextual advertising programs sometimes have strict
							policies that need to be adhered too. Letâs take Google as an
							example.</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
			...
			<div class="row">
				<div class="col-lg-6 p-0">
					<div class="testimonial__text">
						...
						<p>âGoing out after work? Take your butane curling iron with
							you to the office, heat it up, style your hair before you leave
							the office and you wonât have to make a trip back home.â</p>
				...
				<div class="col-lg-6 p-0">
					<div class="testimonial__pic set-bg"
						data-setbg="/static/img/about/testimonial-pic.jpg"></div>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="team__item">
						<img src="/static/img/about/team-1.jpg" alt="">
						<h4>John Smith</h4>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="team__item">
						<img src="/static/img/about/team-2.jpg" alt="">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="team__item">
						<img src="/static/img/about/team-3.jpg" alt="">
						<h4>Sean Robbins</h4>
						<span>Manager</span>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="team__item">
						<img src="/static/img/about/team-4.jpg" alt="">
						<h4>Lucy Myers</h4>
						<span>Delivery</span>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="/static/img/clients/client-1.png" alt=""></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="/static/img/clients/client-2.png" alt=""></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="/static/img/clients/client-3.png" alt=""></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="/static/img/clients/client-4.png" alt=""></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="/static/img/clients/client-5.png" alt=""></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="/static/img/clients/client-6.png" alt=""></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="/static/img/clients/client-7.png" alt=""></a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-6">
					<a href="#" class="client__item"><img
						src="/static/img/clients/client-8.png" alt=""></a>
				</div>
			</div>
		</div>
	</section>
