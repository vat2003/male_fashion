...
<body>
	<div class="main">
		<div class="container a-container" id="a-container">
			<form class="form" id="a-form" method="post" action="/asm/forgotPass_3">
				...
				<span class="form__span">Create new password</span>
				<input class="form__input" type="password" placeholder="Password" name="pw">
				<span style="color: red">${msg_pw}</span>
				<input class="form__input" type="password" placeholder="Re-password" name="repw">
					<span style="color: red">${msg_repw}</span>
				<button class="form__button button submit" formaction="/asm/email/forgotPass_3">RETRIVE</button>
			</form>
		</div>
		*
	</div>
