...
<body>
	...
	<div class="offcanvas-menu-wrapper">
		...
		<div class="offcanvas__nav__option">
			<a href="#" class="search-switch"><img src="/static/img/icon/search.png"
				alt=""></a> <a href="#"><img src="/static/img/icon/heart.png" alt=""></a>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-2.jpg">
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item sale">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-3.jpg">
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-4.jpg">
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
												alt=""> <span>Compare</span></a></li>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item sale">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-6.jpg">
									<span class="label">Sale</span>
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-7.jpg">
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
												alt=""> <span>Compare</span></a></li>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-8.jpg">
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
												alt=""> <span>Compare</span></a></li>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-9.jpg">
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
												alt=""> <span>Compare</span></a></li>
								...
								<div class="product__item__text">
									...
									<h5>$67.24</h5>
									<div class="product__color__select">
										<label for="pc-25"> <input type="radio" id="pc-25">
										</label> <label class="active black" for="pc-26"> <input
											type="radio" id="pc-26">
										</label> <label class="grey" for="pc-27"> <input type="radio"
											id="pc-27">
										</label>
									</div>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item sale">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-10.jpg">
									<span class="label">Sale</span>
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
								...
								<div class="product__item__text">
									...
									<h5>$43.48</h5>
									<div class="product__color__select">
										<label for="pc-28"> <input type="radio" id="pc-28">
										</label> <label class="active black" for="pc-29"> <input
											type="radio" id="pc-29">
										</label> <label class="grey" for="pc-30"> <input type="radio"
											id="pc-30">
										</label>
									</div>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-11.jpg">
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
												alt=""> <span>Compare</span></a></li>
								...
								<div class="product__item__text">
									...
									<h5>$60.9</h5>
									<div class="product__color__select">
										<label for="pc-31"> <input type="radio" id="pc-31">
										</label> <label class="active black" for="pc-32"> <input
											type="radio" id="pc-32">
										</label> <label class="grey" for="pc-33"> <input type="radio"
											id="pc-33">
										</label>
									</div>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item sale">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-12.jpg">
									<span class="label">Sale</span>
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
								...
								<div class="product__item__text">
									...
									<h5>$98.49</h5>
									<div class="product__color__select">
										<label for="pc-34"> <input type="radio" id="pc-34">
										</label> <label class="active black" for="pc-35"> <input
											type="radio" id="pc-35">
										</label> <label class="grey" for="pc-36"> <input type="radio"
											id="pc-36">
										</label>
									</div>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-13.jpg">
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
												alt=""> <span>Compare</span></a></li>
								...
								<div class="product__item__text">
									...
									<h5>$49.66</h5>
									<div class="product__color__select">
										<label for="pc-37"> <input type="radio" id="pc-37">
										</label> <label class="active black" for="pc-38"> <input
											type="radio" id="pc-38">
										</label> <label class="grey" for="pc-39"> <input type="radio"
											id="pc-39">
										</label>
									</div>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									data-setbg="/static/img/product/product-14.jpg">
									<ul class="product__hover">
										<li><a href="#"><img src="/static/img/icon/heart.png" alt=""></a></li>
										<li><a href="#"><img src="/static/img/icon/compare.png"
												alt=""> <span>Compare</span></a></li>
								...
								<div class="product__item__text">
									...
									<h5>$26.28</h5>
									<div class="product__color__select">
										<label for="pc-40"> <input type="radio" id="pc-40">
										</label> <label class="active black" for="pc-41"> <input
											type="radio" id="pc-41">
										</label> <label class="grey" for="pc-42"> <input type="radio"
											id="pc-42">
										</label>
									</div>
								</div>
