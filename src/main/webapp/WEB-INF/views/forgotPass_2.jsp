...
<body>
	<div class="main">
		<div class="container a-container" id="a-container">
			<form class="form" id="a-form" method="post" action="/asm/forgotPass_2">
				...
				<span class="form__span">Please check your email</span>
				<input class="form__input" type="text" placeholder="Enter code" name="code">
			<span style="color: red">${msg}</span>
				<button class="form__button button submit" formaction="/asm/email/forgotPass_2">CONFIRM</button>
			</form>
		</div>
*
	</div>
